...
int main ()
{
  ...
  **/
  ...
  pid_steer.Init(0.1, 0.02, 0.008, 1.2, -1.2);
  pid_throttle.Init(0.02, 0.08, 0.008, 1.0, -1.0);
  ...
  h.onMessage([&pid_steer, &pid_throttle, &new_delta_time, &timer, &prev_timer, &i, &prev_timer](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length, uWS::OpCode opCode)
  {
        ...
        if (s != "") {
          ...
          **/
          error_steer = angle_between_points(x_position, y_position, x_points[index_shortest], y_points[index_shortest]) - yaw;
